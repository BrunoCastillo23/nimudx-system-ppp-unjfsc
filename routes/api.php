...
// Todas estas rutas son consumidas por el SPA (axios) usando la sesión de
// cookie del usuario autenticado (ver bootstrap/app.php -> statefulApi()).
// Sin 'auth' aquí, un visitante sin sesión puede invocarlas igual y el
// código interno cae en fallbacks inseguros (Auth::user() ?? User::first()).
